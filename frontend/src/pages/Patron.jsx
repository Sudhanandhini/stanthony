...
import ban11 from '../assets/15-1.jpg'
import about from "../assets/18(1).jpg"
...
export default function Patron() {
  return (
    <div>
      ...
      <section style={{ background:'#af74bf', minHeight: 500 }} className="py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 max-w-5xl">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <div className="flex-1">
              <p className="text-[#fff] text-sm leading-7 mb-4 text-justify">
              ...
              <div className="mt-6 border-l-4 border-gray-600 pl-4">
                <p className="text-[#fff] text-sm leading-7 italic">
