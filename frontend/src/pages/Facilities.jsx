import fac1 from '../assets/fac/1.webp'
import fac2 from '../assets/fac/2.jpeg'
import fac3 from '../assets/fac/3.webp'
import fac4 from '../assets/fac/4.jpg'
import fac5 from '../assets/fac/5.jpg'
import lab1 from '../assets/fac/lab1.jpg'
...
import fac11 from '../assets/fac/11.png'
import fac12 from '../assets/fac/12.jpg'

import ban1 from "../assets/10-1.jpg"
            ...
            {facilityItems.map((item, i) => (
              ...
              >
                ...
                <div className="md:w-1/3 bg-gradient-to-br from-navy to-maroon flex items-center justify-center min-h-[180px] text-white">
                  ...
                  {item.images && (
                    <div className="absolute flex gap-2 mt-3 flex-wrap justify-center">
                      {item.images.map((img) => (
